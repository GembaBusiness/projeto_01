...
8.  **Registrar user logado**: Um workflow do projeto é acionado para identificar o usuário logado e realizar quaisquer ações de inicialização necessárias.- [Ver detalhes da função `get_profile_by_user_and_company`](docs/3-base-de-dados/tabelas/1-identidade-e-multi-tenancy/profiles/api_profile.md)
