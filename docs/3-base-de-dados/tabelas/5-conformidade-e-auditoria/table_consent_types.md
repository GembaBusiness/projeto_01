...
- **`select`**: Todos os utilizadores podem ler os tipos de consentimento.
- **`insert`/`update`/`delete`**: Apenas um super-administrador pode modificar os tipos de consentimento.

## Notas
- Esta tabela é o catálogo de todos os documentos legais que requerem o consentimento do utilizador.
